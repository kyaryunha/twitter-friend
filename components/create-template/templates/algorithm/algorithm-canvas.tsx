...
import {drawAlgorithmOJ} from "../../canvas-utils/algorithm-layers";
...
const AlgorithmCanvas: NextPage = observer(() => {
    ...
    useEffect(() => {
        ...
        questionStore.bojId,
        questionStore.solvedacTier,
        questionStore.codeforcesId,
        questionStore.codeforcesTier,
        questionStore.atcoderId,
        questionStore.atcoderTier,
